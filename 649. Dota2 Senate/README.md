...
Approach is to take a queue and then put the r and d elements into seperate queue
then until they both are not empty put r = R.front() and d = D.front(); then pop them and if r<d then R.push(r+n) else push d+n.............if r is not empty then return r else return d
